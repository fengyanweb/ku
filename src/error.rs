...
diagnostic_registry! {
    ...
    HttpSharedCallableReassignment => ("E0704", "Cannot replace an HTTP-shared function binding",
        &["HTTP route registration makes directly and indirectly shared function bindings non-reassignable"],
        &["keep the registered binding unchanged; use an independent local binding for a different function value"]),
